   ...
   name:'indexWrapper',
    ...
    methods:{
     ...
     getBasicInfo(){
        ...
        // let url = 'http://120.79.239.247:8080/monitoring/phone/index.html#/?userId=1&loginType=2&accessToken=c6ea88c94fc349478e315782f7bfc760&permissions=2&sn=C00711223301#/'
         this.basic = {
